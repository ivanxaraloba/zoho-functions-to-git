...
export default function CardProject({
  ...
  return (
    <div
      className={cn(
        'group relative flex max-h-28 cursor-pointer flex-row rounded-xl border p-5 px-0 text-left transition duration-150 ease-in-out',
        isActive
          ? 'bg-primary-foreground border-muted-foreground/20'
          : 'hover:bg-primary-foreground/40',
      )}
    >
      <div className="flex w-full flex-col justify-between gap-y-2 px-5">
